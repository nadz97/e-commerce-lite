...
class TealNeumorphTheme extends Tailwind
{
    ...
    public function table(): array
    {
        return [
            'layout' => [
                ...
                'div'       => 'rounded-t-lg relative border-x border-t  shadow-popout',
            ...
            'header' => [
                'thead'    => 'text-brand shadow-sm rounded-t-lg bg-pg-primary-100 dark:bg-pg-primary-900',
                'tr'       => '',
            ...
            'body' => [
                ...
                'tdSummarize'        => 'p-2 whitespace-nowrap dark:text-pg-primary-200 text-sm text-brand text-right space-y-2',
                'trSummarize'        => '',
                'tdFilters'          => '',
                'trFilters'          => '',
    ...
    public function editable(): array
    {
        return [
            ...
            'input' => 'focus:ring-primary-600 focus-within:focus:ring-primary-600 focus-within:ring-primary-600 dark:focus-within:ring-primary-600 flex rounded-md ring-1 transition focus-within:ring-2 dark:ring-pg-primary-600 dark:text-pg-primary-300 text-gray-600 ring-gray-300 dark:bg-pg-primary-800 bg-teal dark:placeholder-pg-primary-400 w-full rounded-md border-0 bg-transparent py-1.5 px-2 ring-0 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6 w-full',
        ];
    }
    ...
    public function checkbox(): array
    {
        return [
            ...
            'input' => 'form-checkbox dark:border-dark-600 border-1 dark:bg-dark-800 rounded border-gray-300 bg-teal transition duration-100 ease-in-out h-4 w-4 text-primary-500 focus:ring-primary-500 dark:ring-offset-dark-900',
        ];
    }
    ...
    public function filterDatePicker(): array
    {
        return [
            ...
            'input' => 'flatpickr flatpickr-input w-full bg-white/10 text-brand placeholder-brand/60 rounded-lg pl-4 pr-4 py-2
                    ...
                    outline-none transition-all duration-200 sm:text-sm sm:leading-6',
        ];
    }
    ...
    public function filterNumber(): array
    {
        return [
            ...
            'input' => 'w-full min-w-[5rem] block focus:ring-primary-600 focus-within:focus:ring-primary-600 focus-within:ring-primary-600 dark:focus-within:ring-primary-600 flex rounded-md ring-1 transition focus-within:ring-2 dark:ring-pg-primary-600 dark:text-pg-primary-300 text-gray-600 ring-gray-300 dark:bg-pg-primary-800 bg-teal dark:placeholder-pg-primary-400 rounded-md border-0 bg-transparent py-1.5 pl-2 ring-0 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6',
        ];
    }
    ...
    public function filterSelect(): array
    {
        return [
            ...
            'base'   => '',
            'select' => 'appearance-none w-full bg-white/10 text-brand placeholder-brand/60 rounded-lg pl-4 pr-4 py-2
                     border border-white/20 hover:border-white/40 focus:border-white/60
                     focus:bg-white/15 hover:bg-white/15
                     shadow-insetpop focus:shadow-popout
                     outline-none transition-all duration-200 sm:text-sm sm:leading-6',
    ...
    public function filterInputText(): array
    {
        return [
            ...
            'select' => 'appearance-none w-full bg-white/10 text-brand placeholder-brand/60 rounded-lg pl-4 pr-4 py-2
                     ...
                     shadow-insetpop focus:shadow-popout
                     outline-none transition-all duration-200 sm:text-sm sm:leading-6',
            'input'  => 'w-full bg-white/10 text-brand placeholder-brand/60 rounded-lg pl-4 pr-4 py-2
                     border border-white/20 hover:border-white/40 focus:border-white/60
                     focus:bg-white/15 hover:bg-white/15
                     shadow-insetpop focus:shadow-popout
                     outline-none transition-all duration-200 sm:text-sm sm:leading-6',
    ...
    {
        return [
            'input' => 'w-full bg-white/10 text-brand placeholder-brand/60 rounded-lg pl-10 pr-4 py-2
                    border border-white/20 hover:border-white/40 focus:border-white/60
                    focus:bg-white/15 hover:bg-white/15
                    shadow-insetpop focus:shadow-popout
                    outline-none transition-all duration-200',
            'iconClose' => 'text-pg-primary-400 dark:text-pg-primary-200',
            'iconSearch' => 'absolute left-3 top-1/2 -translate-y-1/2 text-brand/60 transition-colors duration-200 peer-focus:text-brand',
        ];
    }
}
