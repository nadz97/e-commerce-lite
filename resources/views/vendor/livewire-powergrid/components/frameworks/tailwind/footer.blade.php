<div>
    ...
    <footer id="pg-footer" @class([
        ...
        theme_style(
            ...
            'md:flex md:flex-row w-full items-center py-3 bg-white/10 overflow-y-auto pl-2 pr-2 relative dark:bg-pg-primary-800') => blank(data_get($setUp, 'footer.pagination')),
    ])>
